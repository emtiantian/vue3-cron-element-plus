...
Package: @emtt/vue3-cron-element-plus. Scope belongs to the user's npm organization; GitHub account is emtiantian. Repository is configured as https://github.com/emtiantian/vue3-cron-element-plus.git.
...
Vue and Element Plus are peer/external dependencies. TypeScript strict, plain CSS variables, pnpm, Vite, bilingual README. Manual npm release; CI does not publish. `site/` is the GitHub Pages consumer and validates the generated npm tarball before building.
